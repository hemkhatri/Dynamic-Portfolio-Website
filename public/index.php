...
$pageTitle = "Hem B. Khatri — Senior Full Stack Developer in Nepal";
$pageMeta  = [
    'description'  => 'Portfolio of Hem B. Khatri — Senior Full Stack Developer based in Nepal with 4+ years building scalable REST APIs, backend architectures, and modern web applications using Python, Django, and PostgreSQL.',
    'keywords'     => 'Hem Khatri, Full Stack Developer Nepal, Senior Developer Nepal, Python Django developer, portfolio Nepal, hemkhatri.com.np, backend engineer Kathmandu',
    'og_type'      => 'website',
    'og_image_alt' => 'Hem B. Khatri — Senior Full Stack Developer Nepal',
...
<div id="about" class="mb-8">
    <img src="public//assets/favicon/profile.png" alt="Hem B. Khatri"
    ...
    <div
        ...
        <div class="group relative w-64 h-80 shadow-2xl border border-white/5 flex-shrink-0 transform -rotate-2">
            ...
            <div class="w-full h-full rounded-3xl overflow-hidden relative">
                <img src="public/assets/images/badimalika.jpg" alt="Badimalika" class="w-full h-full object-cover">
        ...
        <div class="group relative w-64 h-80 shadow-2xl border border-white/5 flex-shrink-0 transform rotate-3">
            ...
            <div class="w-full h-full rounded-3xl overflow-hidden relative">
                <img src="public/assets/images/mani_baudha.jpg" alt="Mani of Buddha Religion"
        ...
        <div class="group relative w-64 h-80 shadow-2xl border border-white/5 flex-shrink-0 transform -rotate-2">
            <!-- Image Wrapper to clip corners safely -->
            <div class="w-full h-full rounded-3xl overflow-hidden relative">
                <img src="public/assets/images/marigold.jpg" alt="Marigold Flower" class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent"></div>
            </div>
            <!-- Tooltip -->
            <span
        ...
        <div class="group relative w-64 h-80 shadow-2xl border border-white/5 flex-shrink-0 transform rotate-2">
            <!-- Image Wrapper to clip corners safely -->
            <div class="w-full h-full rounded-3xl overflow-hidden relative">
                <img src="public/assets/images/Mountains-Nepal-II.jpg" alt="Mountains of Nepal"
                    class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent"></div>
            </div>
            <!-- Tooltip -->
        ...
        <div class="group relative w-64 h-80 shadow-2xl border border-white/5 flex-shrink-0 transform -rotate-2">
            <!-- Image Wrapper to clip corners safely -->
            <div class="w-full h-full rounded-3xl overflow-hidden relative">
                <img src="public/assets/images/nepal boudhanath stupa.jpg" alt="Nepal Boudhanath stupa"
                    class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent"></div>
            </div>
            <!-- Tooltip -->
                ...
                foreach ($display_posts as $post):
                    ...
                    <article class="group relative flex flex-col items-start">
                        <h2 class="text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
                            ...
                            <!-- NEW CLEAN VERSION -->
                            <a href="articles/<?php echo $post['slug']; ?>">
